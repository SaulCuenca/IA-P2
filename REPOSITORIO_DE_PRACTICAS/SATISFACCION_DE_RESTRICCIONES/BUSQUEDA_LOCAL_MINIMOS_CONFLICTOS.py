...
#El algoritmo de busqueda local para resolver problemas de "Minimos Conflictos" es una tecnica utilizada para encontrar soluciones en problemas de satisfacción de restricciones (CSP, por sus siglas en ingles). 
#Este codigo resuelve el problema de las N-Queens utilizando el algoritmo de Mínimos Conflictos. Ajusta el valor de n en la parte superior del script para cambiar el tamano del tablero y encontrar soluciones para diferentes valores de N.
