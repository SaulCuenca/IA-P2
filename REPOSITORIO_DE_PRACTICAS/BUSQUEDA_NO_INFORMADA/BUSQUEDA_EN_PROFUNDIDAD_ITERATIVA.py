...
if result is not None:
    ...
    #La busqueda en profundidad iterativa (Iterative Deepening Depth-First Search, IDDFS) es una estrategia de búsqueda que combina la profundidad de la búsqueda en profundidad (DFS) con la iteración progresiva para encontrar soluciones en un grafo con una profundidad desconocida.
