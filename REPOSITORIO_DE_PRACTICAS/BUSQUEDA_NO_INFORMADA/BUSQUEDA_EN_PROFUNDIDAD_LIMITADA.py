...
#La busqueda en profundidad limitada (Limited Depth-First Search, LDFS) es una variante de la búsqueda en profundidad (DFS) en la que se establece un límite máximo en la profundidad hasta la cual se explorarán los nodos. 
