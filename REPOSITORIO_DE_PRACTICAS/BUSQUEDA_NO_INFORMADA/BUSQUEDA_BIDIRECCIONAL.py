    ...
    while forward_queue and backward_queue:
        ...
        for neighbor in graph[current_node]:
            ...
            if neighbor in backward_visited:
                return neighbor  # Se encontro un nodo de conexión
...
#La busqueda bidireccional es una estrategia de búsqueda que busca una solución desde dos direcciones: una desde el nodo inicial y otra desde el nodo objetivo. Esto puede ser más eficiente en ciertos casos que una búsqueda unidireccional, ya que reduce la cantidad de nodos que se deben explorar.
