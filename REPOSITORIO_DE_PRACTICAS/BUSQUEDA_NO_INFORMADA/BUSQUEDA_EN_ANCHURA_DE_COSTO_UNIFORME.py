...
def uniform_cost_search(graph, start, goal):
    ...
    while priority_queue:
        ...
        if node == goal:
            return cost  # Devolvemos el costo minimo para llegar al objetivo
...
if __name__ == "__main__":
    ...
    if cost != float('inf'):
        print(f"El costo minimo de {start_node} a {goal_node} es {cost}.")
    else:
        print(f"No se encontro una ruta de {start_node} a {goal_node}.")
