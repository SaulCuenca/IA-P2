...
for step in path:
    print(step)
    #El Aprendizaje por Refuerzo Pasivo es una rama del aprendizaje automatico que implica que un agente aprenda a realizar acciones optimas en un entorno a traves de la observación de ejemplos en lugar de interactuar activamente con el entorno.
