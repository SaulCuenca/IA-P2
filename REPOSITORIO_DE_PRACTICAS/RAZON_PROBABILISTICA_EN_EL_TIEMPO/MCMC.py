...
# Funcion para realizar MCMC con el Metodo de Metropolis-Hastings
def metropolis_hastings(target_distribution, num_samples):
    ...
    for _ in range(num_samples):
        ...
        # Calcular la razon de aceptación
        ...
        # Aceptar o rechazar la muestra propuesta segun la razón de aceptacion
