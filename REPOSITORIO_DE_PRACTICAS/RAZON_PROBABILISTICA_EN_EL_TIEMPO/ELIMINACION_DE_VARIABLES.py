...
# Funcion para realizar inferencia por eliminación de variables
...
for state, probability in marginal_probabilities.items():
    print(f"La probabilidad marginal de estar en el estado '{state}' despues de la secuencia es: {probability:.4f}")
