...
# Definir las matrices de transicion, recompensa y observacion
...
# Funcion para actualizar la creencia del agente
...
# Funcion para tomar una decision optima utilizando la estrategia de politica optima
